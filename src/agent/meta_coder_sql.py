...
class MetaCoderSQLPipeline(class_sql_reader):
    ...
    def verify_environment(self) -> bool:
        ...
        # Initialisierung der Tabellen in der Existenz-Datenbank
